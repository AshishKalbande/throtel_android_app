...
public class AddsAdapter extends PagerAdapter {
    ...
    public AddsAdapter(Context context, ArrayList<BannerData> rowItems) {
...
//        String url = RetrofitClient.BASE_BANNER_IMAGE_URL;
//        String url ="http://throtel.com/test-student-api/get-banner-list-view/"+rowItems.get(position).getBannerImage();
