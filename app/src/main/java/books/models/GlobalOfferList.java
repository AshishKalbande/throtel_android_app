...
public class GlobalOfferList implements Serializable {

    private final static long serialVersionUID = -8636918215453922537L;
    @SerializedName("id")
    @Expose
    private int id;
    @SerializedName("mainGroupId")
    @Expose
    private Object mainGroupId;
    ...
    public Object getMainGroupId() {
        return mainGroupId;
    }

    public void setMainGroupId(Object mainGroupId) {
