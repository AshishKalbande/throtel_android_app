        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (product.getProductUnit().length() > 1 ) {
                  ...
                  //  selectedSize = lables.indexOf(lables.get(position));
                    selectedWeight = selectedWeightNew;
                    //selectedSize = selectedWeightNew;
               ...
               // intent.putExtra("SubproductId", selectedSize);
...
//                    {
                        //Add default selected Qty product
                        AddToCartProduct(product, 1, position);
//                    } else
...
//        });
    ...
    //Add Product To Cart
    private void AddToCartProduct(final ProductList product, int Qty, final int rowIndex) {
...
//    }
    ...
    public interface StatusUpdateListener {
        void onStatusUpdate(int index, ProductList product);
    }
    ...
    static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvName, tvPrice, tvSellingPrice, tvDiscount, tvWeight, tvSize;
