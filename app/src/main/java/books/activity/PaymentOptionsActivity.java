...
import static books.fragments.BaseFragment.TotalAmount;
                        ...
                        public void onResponse(Call<OrderDataResponse> call, Response<OrderDataResponse> response) {
                            ...
                            if (response.body() != null && response.body().getStatus().equalsIgnoreCase("true")) {
                                ...
                                if (response.body().getData().getOrderDetail().getOrderId() != null) {
                                    ...
                                    startActivity(new Intent(PaymentOptionsActivity.this, HomeBookActivity.class));
                                    finishAffinity();
                                }
                            } else {
                                //showToast(getString(R.string.error_general));
                                Toast.makeText(PaymentOptionsActivity.this, "error in api", Toast.LENGTH_SHORT).show();
                            }
                        }
