...
//                .into(ivProfile);
        tvName.setText(localData.getBookSignIn().getName());
        tvMobile.setText(localData.getBookSignIn().getPhone());
        tvPincode.setText(localData.getBookSignIn().getPincodeNumber() + "-" + localData.getBookSignIn().getCityName());
    }
