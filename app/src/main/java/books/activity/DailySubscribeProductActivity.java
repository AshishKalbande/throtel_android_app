...
//import static books.fragments.BaseFragment.WalletAmount;
...
public class DailySubscribeProductActivity extends BaseActivity implements SlotListAdapter.OnItemClickListener, PaymentResultListener {
    ...
    private void setData() {
        //total of product
        productSellingPrice = Double.parseDouble(product.getProductSellingPrice().toString());
        SubscribeDailyTotalAmount = Double.parseDouble(product.getProductSellingPrice().toString()) * Double.parseDouble(Qty);

        tvProductName.setText(product.getProductName());
        tvProductWeight.setText(product.getProductUnit());
        // tvSellingPrice.setText(SubscribeDailyTotalAmount.toString());
        tvProductPrice.setText("₹ " + product.getProductSellingPrice().toString());
        tvSellingPrice.setText(Html.fromHtml("<strike> ₹ " + product.getProductNetPrice().toString() + "</strike>"));
        ...
        tvChangeAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent ca = new Intent(DailySubscribeProductActivity.this, books.activity.AddressListActivity.class);
