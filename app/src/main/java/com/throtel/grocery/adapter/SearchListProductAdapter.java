...
import com.throtel.grocery.activity.SearchProductActivity;
...
public class SearchListProductAdapter extends RecyclerView.Adapter<SearchListProductAdapter.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SearchListProductAdapter.ItemViewHolder(view);
    }
                ...
                if (product.getSubProductList().size() > 1) {
                    ...
                    builder.setAdapter(dataAdapter, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            holder.tvPrice.setText(product.getSubProductList().get(which).getProductNetPrice().toString());
                            holder.tvSellingPrice.setText(Html.fromHtml("<strike> ₹ " + product.getSubProductList().get(which).getProductSellingPrice().toString() + "</strike>"));
