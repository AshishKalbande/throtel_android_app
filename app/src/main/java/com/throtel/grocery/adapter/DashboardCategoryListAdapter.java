...
public class DashboardCategoryListAdapter extends RecyclerView.Adapter<DashboardCategoryListAdapter.ItemViewHolder> {
    ...
    public DashboardCategoryListAdapter(Context context, ArrayList<GroupList> rowItems, OnItemClickListener onItemClickListener) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new DashboardCategoryListAdapter.ItemViewHolder(view);
    }
