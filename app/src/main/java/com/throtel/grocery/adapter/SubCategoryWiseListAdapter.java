...
public class SubCategoryWiseListAdapter extends RecyclerView.Adapter<SubCategoryWiseListAdapter.ItemViewHolder> {
    ...
    public SubCategoryWiseListAdapter(Context context, ArrayList<ProductList> rowItems, OnItemClickListener onItemClickListener, StatusUpdateListener statusUpdateListener) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SubCategoryWiseListAdapter.ItemViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder holder, final int position) {
                ...
                if (product.getSubProductList().size() > 1) {
                    ...
                    builder.setAdapter(dataAdapter, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            holder.tvPrice.setText(Html.fromHtml("<strike> ₹ " +product.getSubProductList().get(which).getProductNetPrice().toString()+ "</strike>"));
                            holder.tvSellingPrice.setText( product.getSubProductList().get(which).getProductSellingPrice().toString() );
        ...
        if (product.getSubProductList().size() > 0) {
            ...
            holder.tvPrice.setText(Html.fromHtml("<strike> ₹ "  + subProduct.getProductNetPrice().toString()+ "</strike>"));
            holder.tvSellingPrice.setText( subProduct.getProductSellingPrice().toString() );
            ...
            public void onClick(View view) {
                ...
                if (product.getSubProductList().size() == 1) {
                    ...
                    if (product.getSubProductList().get(selectedWeightNew).getAvailableQuantity() > 0) {
                        //Add default selected Qty product
                        AddToCartProduct(product.getSubProductList().get(selectedWeightNew), 1, position);
                    } else
                        Toast.makeText(context, "Out Of Stock Product", Toast.LENGTH_LONG).show();
                }
        ...
        //Add item to Subscribtion
//        holder.tvAddProductToSubscribe.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                //AddToSubscribeProduct(product.getSubProductList().get(selectedWeightNew), 1);
//            }
//        });
    ...
    //Add Product To Cart
    private void AddToCartProduct(final SubProductList product, int Qty, final int rowIndex) {
    ...
    //Add Product To Cart
//    private void AddToSubscribeProduct(final SubProductList product, int Qty) {
//        MyProgress.start(context);
//        LocalData localData = LocalData.getInstance(context);
//        Call<DataResponse> call = RetrofitClient.getRetrofitClient().
//                addToSubscribeProduct(product.getProductId().toString(), localData.getCustomerId(), String.valueOf(Qty));
//        call.enqueue(new Callback<DataResponse>() {
//            @Override
//            public void onResponse(Call<DataResponse> call, Response<DataResponse> response) {
//                MyProgress.stop();
...
//    }
    ...
    static class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvAddProductToSubscribe;
        ImageView ivImage;
        ...
        public ItemViewHolder(View itemView) {
            ...
            //tvAddProductToSubscribe = itemView.findViewById(R.id.tv_subscribe);
