...
public class B2BGroupWiseListAdapter extends RecyclerView.Adapter<B2BGroupWiseListAdapter.ItemViewHolder> {
    ...
    public B2BGroupWiseListAdapter(Context context, ArrayList<CategoryList> rowItems, OnItemClickListener onItemClickListener) {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new B2BGroupWiseListAdapter.ItemViewHolder(view);
    }
