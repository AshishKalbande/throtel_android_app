...
import com.throtel.grocery.activity.GroupWiseCategoryActivity;
import com.throtel.grocery.activity.ProductDetailsActivity;
import com.throtel.grocery.adapter.AddsAdapter;
import com.throtel.grocery.adapter.CategoryOffersAdapter;
import com.throtel.grocery.adapter.DashboardCategoryListAdapter;
import com.throtel.grocery.adapter.DashboardDailyNeedsAdapter;
import com.throtel.grocery.adapter.GlobalOffersAdapter;
...
import static com.throtel.grocery.fragments.CategoryFragment.REQUEST_CODE;
...
//    }
    ...
    private void setUpGroupList(ArrayList<GroupList> groupList) {
        ...
        rv_Category_List.setAdapter(new DashboardCategoryListAdapter(context, groupList, this));
    }
