...
import com.throtel.grocery.adapter.B2BSubCategoryWiseListAdapter;
...
public class B2BSubCategoryListActivity extends BaseActivity implements SubCategoryListAdapter.OnItemClickListener, B2BSubCategoryWiseListAdapter.StatusUpdateListener {
    ...
    private void getSubCategoryWiseProductList(String subCategoryId, int pageNo, int limit) {
        ...
        Call<SubCategoryWiseProductDataResponse> call = RetrofitClient.getRetrofitClient().getSubCategoryWiseListData(limit, localData.getCustomerId(), subCategoryId, String.valueOf(pageNo), category.getMainCategoryId().toString());
