...
public class RetrofitClient {
    ...
    public static String BASE_GROUP_IMAGE_URL = "http://throtel.com/uploads/grocery-main-group/";
    ...
    public static final String BASE_GROUP_WISE_IMAGE_URL = BASE_IMAGE_URL + "uploads/grocery-main-category/";
    public static final String BASE_PRODUCT_IMAGE_URL = BASE_IMAGE_URL + "uploads/grocery-product/";
    ...
    public static final String BASE_BANNER_IMAGE_URL = BASE_IMAGE_URL + "uploads/banner/";
